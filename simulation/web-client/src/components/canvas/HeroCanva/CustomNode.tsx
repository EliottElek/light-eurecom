...
function CustomNode({ data }: { data: any }) {
    return (
        <div className='relative'>
            <div className="px-4 py-2 min-h-400 rounded-md bg-transparent ">
                <div className="flex">
            ...
            {/* {data.video &&
                <div className='absolute top-4 right-3 -translate-y-1/3 translate-x-full overflow-hidden shadow rounded-sm border border-gray-400/20 bg-white'>
