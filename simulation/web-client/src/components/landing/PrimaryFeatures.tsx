      ...
      <Container>
        <div className="mx-auto max-w-2xl lg:mx-0 lg:max-w-3xl">
          ...
          <p className="mt-2 text-lg text-gray-400">
            Vivamus at magna ac diam porttitor lacinia ac sit amet massa. Morbi hendrerit faucibus mauris vel blandit. Pellentesque eu bibendum dui. Vivamus vitae condimentum elit. Vestibulum a sollicitudin diam, a condimentum lectus. Quisque eros dui, suscipit eget tortor eget, tincidunt suscipit justo. Pellentesque mollis odio eget eros convallis dignissim.
          </p>
        </div>
      </Container>
