...
def start_processes(id):
    ...
    return sender_process, receiver_process_1, receiver_process_2
...
if __name__ == '__main__':
    ...
    create_simulation_file(id, 1, 'Basic XOR - 2 receivers', "In this example, we're performing a basic multicast flow between two receivers. This simply demonstrates that two receivers, subscribed to a multicast server, receive the same packets.")
    try:
        start_processes(id)
