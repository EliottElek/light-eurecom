...
if __name__ == '__main__':
    ...
    print(id)
    create_simulation_file(id, 'Basic example XOR', "In this example, we're performing a basic multicast flow between two receivers. This simply demonstrates that two receivers, subscribed to a multicast server, receive the same packets.")
    try:
        start_processes(id)
